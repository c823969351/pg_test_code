...
#pytest -vs .\test_M695_2.py --count=5  --repeat-scope=session -x
com = "COM21"    
...
if __name__ == "__main__":
    ...
    pg.close'''
    #pytest.main(["-s", "test_M695_2.py"])
    pytest.main(["-v", "test_M695_2.py",'--html=./M695_2_report.html','--count=100','--repeat-scope=session'])